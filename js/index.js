function init() {
    ...
    var loadData = convertData([
      ...
      { name: "宜春", value: randomData() },
      { name: "日喀则", value: randomData() },
      { name: "伊春", value: randomData() },
      { name: "鹤岗", value: randomData() },
      ...
      { name: "本溪", value: randomData() },
      { name: "大连", value: randomData() },
      { name: "锦州", value: randomData() },
    ]);
    ...
    option = {
      ...
      geo: {
        ...
        itemStyle: {
          ...
          emphasis: {
            areaColor: "rgba(131, 131, 213, 0.3)",
            shadowOffsetX: 0,
            shadowOffsetY: 0,
            shadowBlur: 20,
            borderWidth: 0,
            shadowColor: "rgba(14, 041, 014, 0.5)",
          },
        },
        silent: false,
      },
